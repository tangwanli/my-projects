...
<table width="100%" height="78" border="0" cellpadding="0" cellspacing="0" background="../image/bg-1.jpg" >
  <tr>
    <td><table width="769" height="78" border="0" align="center" cellpadding="0" cellspacing="0" background="../image/bg-2.jpg" >
      <tr>
        <td></td>
      </tr>
    </table></td>
